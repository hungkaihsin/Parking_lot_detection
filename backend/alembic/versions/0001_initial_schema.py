...
Revises: 
Create Date: 2025-10-08 18:20:00.000000
...
def upgrade() -> None:
    ...
    op.create_table('stalls',
        ...
        sa.Column('is_occupied', sa.Boolean(), server_default=sa.text('false'), nullable=False),
    ...
    op.create_table('events',
        ...
        sa.Column('stall_id', sa.VARCHAR(), nullable=False),
        ...
        sa.ForeignKeyConstraint(['stall_id'], ['stalls.id'], name=op.f('events_stall_id_fkey'), ondelete='CASCADE'),
