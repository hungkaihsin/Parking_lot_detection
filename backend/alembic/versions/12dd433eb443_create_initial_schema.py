...
Revision ID: 12dd433eb443
Revises: 
Create Date: 2025-10-09 00:27:15.700091
...
def upgrade() -> None:
    ...
    sa.Column('is_occupied', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False, nullable=False),
